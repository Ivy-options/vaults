...
test("every old anchor resolves, every moment has one summary paragraph, no tile overflows", async () => {
  ...
  try {
    ...
    assert.deepEqual(stations, ["before-the-vault", "open", "auction", "live", "settled", "vault-terms", "operator-runbook", "cash-settlement-pricing", "releases-and-registry", "project"]);
