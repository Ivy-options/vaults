...
describe("scaffold", () => {
  it("deploys MockERC20 with custom decimals and mints", async () => {
  ...
  it("applies a burn-on-transfer fee when configured", async () => {
  ...
  it("has the ERC1967Proxy artifact available", async () => {
