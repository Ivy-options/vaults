...
- American cash early exercise uses fresh current spot before expiry. At or after expiry, cash exercise uses the finalized expiry price, including for European cash options. Cash expiration is available at or after expiry. Finalized expiry reports remain required; current spot must not replace them.
